...
export const CmdbModule: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      {/* 2. SUB-NAVIGATION TABS (ALINHADOS E VISÍVEIS EM UMA ÚNICA PÁGINA) */}
      <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 p-2 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-xs text-xs">
        
        <button
          onClick={() => setActiveTab('visao-geral')}
          className={`px-3.5 py-2 rounded-xl font-bold transition-all flex items-center gap-2 cursor-pointer text-xs shadow-2xs ${
        ...
        >
          <Activity className={`w-4 h-4 ${activeTab === 'visao-geral' ? 'text-white' : 'text-blue-500'}`} />
        ...
        >
          <Network className={`w-4 h-4 ${activeTab === 'topologia' ? 'text-white' : 'text-blue-500'}`} />
        ...
        >
          <Layers className={`w-4 h-4 ${activeTab === 'itens' ? 'text-white' : 'text-indigo-500'}`} />
        ...
        >
          <Share2 className={`w-4 h-4 ${activeTab === 'relacionamentos' ? 'text-white' : 'text-blue-500'}`} />
        ...
        >
          <Network className={`w-4 h-4 ${activeTab === 'dependencias' ? 'text-white' : 'text-emerald-500'}`} />
        ...
        >
          <AlertOctagon className={`w-4 h-4 ${activeTab === 'impacto' ? 'text-white' : 'text-red-500'}`} />
        ...
        >
          <Box className={`w-4 h-4 ${activeTab === 'servicos' ? 'text-white' : 'text-purple-500'}`} />
        ...
        >
          <History className={`w-4 h-4 ${activeTab === 'historico' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`} />
        ...
        >
          <Wifi className={`w-4 h-4 ${activeTab === 'discovery' ? 'text-white' : 'text-teal-500'}`} />
        ...
        >
          <FileSpreadsheet className={`w-4 h-4 ${activeTab === 'import-export' ? 'text-white' : 'text-emerald-500'}`} />
        ...
        >
          <FileText className={`w-4 h-4 ${activeTab === 'relatorios' ? 'text-white' : 'text-blue-500'}`} />

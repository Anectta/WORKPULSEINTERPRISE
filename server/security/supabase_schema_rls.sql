-- ============================================================================
-- WORKPULSE ENTERPRISE — SECURITY & PENTEST MODULE
-- SUPABASE POSTGRESQL DDL, CONSTRAINTS, INDEXES & ROW LEVEL SECURITY (RLS)
-- ETAPA 8: HARDENING & PREPARAÇÃO PARA PRODUÇÃO
-- ============================================================================
...
-- Políticas de Isolamento Multi-Tenant para as tabelas principais
-- 1. Scopes
...
-- 8. Audit Logs: READ-ONLY e APPEND-ONLY (Proibido UPDATE ou DELETE)
...
-- Bloqueio explícito de UPDATE e DELETE na tabela de auditoria
